...
public class AuthController {
    ...
    public AuthController(UserService userService, JwtService jwtService, AuthenticationManager authenticationManager, BCryptPasswordEncoder passwordEncoder) {
    ...
    public ResponseEntity<?> login(@Valid @RequestBody UserLoginRequest userLoginRequest) throws Exception {
        userService.getUserByEmail(userLoginRequest.getEmail());
